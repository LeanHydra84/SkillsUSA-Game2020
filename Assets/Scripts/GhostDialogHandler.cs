...
public class GhostDialogHandler : MonoBehaviour
{
    ...
    private void Start()
    {
        if(name == "Uncle Vicente") lines = "It’s my least favorite nephew!\nWhy did you have to come to my rescue?" +
                ...
                "\nIt's also the reason why I can’t move...\nIt’s almost like they cursed me to this piano!" +
                "\nMaybe if you finish the song that I was playing…\nAlthough you happen to be the worst player in the family." +
                "\nIf only you were more like the rest of the family, instead of choosing to play trumpet." +
                "\nIt’s fine, just go find the sheet music, and play the pia-\nTHOSE LITTLE  BUGGERS STOLE THE KEYS RIGHT OFF MY PIANO!" +
                ...
                "\nThose are the ones with malicious intent, they might just be the ones who stole the keys." +
                "\nYou should hurry, otherwise I might end up haunting you!";
    }

    public void updateLine()
    {
        if (lineNumber > 0) lines = "...\nHave you gotten the keys yet?";
    }
